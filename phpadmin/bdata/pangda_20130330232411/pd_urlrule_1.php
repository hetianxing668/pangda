...
E_D("replace into `pd_urlrule` values('1','content','category','1','{\$categorydir}{\$catdir}/index.html|{\$categorydir}{\$catdir}/{\$page}.html','news/china/1000.html');");
...
E_D("replace into `pd_urlrule` values('11','content','show','1','{\$year}/{\$catdir}_{\$month}{\$day}/{\$id}.html|{\$year}/{\$catdir}_{\$month}{\$day}/{\$id}_{\$page}.html','2010/catdir_0720/1_2.html');");
E_D("replace into `pd_urlrule` values('12','content','show','1','{\$categorydir}{\$catdir}/{\$year}/{\$month}{\$day}/{\$id}.html|{\$categorydir}{\$catdir}/{\$year}/{\$month}{\$day}/{\$id}_{\$page}.html','it/product/2010/0720/1_2.html');");
