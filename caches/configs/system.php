...
'cookie_pre' => 'uaGmf_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'app_path' => 'http://localhost.pangda.com/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => '2yOCR9Qt9H8H0DUnbSho', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://localhost.pangda.com/phpsso_server',	//接口地址
'phpsso_auth_key' => 'gN2PGmZubQLV5noBFfn8W6SIvpbWfKyR', //加密密钥
